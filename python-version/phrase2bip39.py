...
if __name__ == "__main__":
    ...
    print("wallet seeds. The purpose: ONE phrase generates")
    ...
    print("=" * 50)
    print("STEP 10: SELLING BITCOIN & SECURITY")
    print("=" * 50)
    print()
    print("SELLING BITCOIN FOR FIAT CURRENCY:")
    print()
    print("Option 1: Reputable Wallet Services")
    print("• Strike: strike.me (US, El Salvador)")
    print("• Wallet of Satoshi: walletofsatoshi.com")
    print("• Send small test amount first")
    print("• These services can convert to local currency")
    print()
    print("Option 2: P2P Exchanges")
    print("• OrdenesP2P on Telegram (Colombian Pesos)")
    print("• LocalBitcoins, Bisq, HodlHodl")
    print("• Trade directly with other people")
    print("• Always use escrow services")
    print("• Meet in public places for cash trades")
    print()
    print("⚠️  COMPUTER SECURITY WARNING:")
    print()
    print("KEYLOGGER RISK:")
    print("• Hackers can record every keystroke")
    print("• They can see passwords as you type them")
    print("• They can capture screenshots of your screen")
    print("• Your computer may be compromised without you knowing")
    print()
    print("FOR HIGH-VALUE AMOUNTS:")
    print("• Use ColdCard hardware wallet (coldcard.com)")
    print("• Air-gapped device = 24-word master seed NEVER connects to internet")
    print("• Sign transactions offline, transfer via SD card")
    print("• Eliminates keylogger/malware risk completely")
    print("• Worth the cost for serious Bitcoin storage")
    print()
    print("OPERATIONAL SECURITY:")
    print("• Use dedicated computer for Bitcoin only")
    print("• Fresh OS install with no other software")
    print("• Disable WiFi when entering sensitive data")
    print("• Use live Linux USB for maximum security")
    print()

    print("=" * 50)
    print("STEP 11: IF COMPROMISED")
    print("=" * 50)
    print()
    print("IF SOMEONE FORCES ACCESS:")
    print("1. Give them ONLY your 24 words.")
    print("2. They find Wallet #1 (basic, low funds)")
    print("3. Smart ones find Wallet #2 (duress, more funds)")
    ...
    print("• That there's a 3rd wallet with the real funds.")
    print()
    ...
    print("=" * 50)
    print("STEP 12: AFTER COMPROMISE")
    print("=" * 50)
    print()
